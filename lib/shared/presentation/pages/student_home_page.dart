...
// 🚀 CORRECTION : Chemin du profil (supposant qu'il est dans un dossier 'pages' et non 'todo')
...
class _StudentHomePageState extends State<StudentHomePage> {
  ...
  List<String> icons = [
    ...
    'assets/icons/internshipD.png', // Par défaut, internshipD
  ...
  // Méthode de navigation vers le profil
  void _navigateToProfile() {
    Navigator.push(
      context,
      MaterialPageRoute(
        // 🚀 CORRECTION : Le paramètre 'hasProfileData' est supprimé
  ...
  void _onLongPressMoveUpdateMiddleButton(
    ...
    const double popoverWidth = 220;
    const double popoverHeight = 100;
    ...
    if (localOffset.dy > popoverTop &&
        localOffset.dy < popoverTop + popoverHeight) {
  ...
  void _onFloatingIconTap(int idx) {
    if (floatingIndex == null) {
      setState(() {
        floatingIndex = idx;
        floatingMessage = 'choose the icon to replace, click away to cancel';
      });
    } else if (floatingIndex != idx) {
      _swapIcons(floatingIndex!, idx);
      setState(() {
        floatingIndex = null;
        floatingMessage = null;
        isFloating = false;
                ...
                child: Row(
                  children: [
                    Checkbox(
                      ...
                      onChanged: (v) =>
                          setState(() => hasInternship = v ?? false),
                    ),
                    const Text(
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushNamedAndRemoveUntil(
                              context, '/role_select', (route) => false);
                        },
                  ...
                  children: [
                    for (int i = 0; i < icons.length; i++)
                      i == 2
                          ? GestureDetector(
                        onLongPressStart:
                        _onLongPressStartMiddleButton,
                        onLongPressMoveUpdate: (details) =>
                            _onLongPressMoveUpdateMiddleButton(
                                details, context),
                        ...
                        child: Container(
                          ...
                          child: Image.asset(
                            i == 1
                                ...
                                : i == 4
                                ? (_selectedIndex == 4
                                ? 'assets/icons/Save icon red.png'
                                : icons[4])
                                : icons[i],
                            width: 28,
                            color: _selectedIndex == i &&
                ...
                child: Column(
                  children: [
                    ...
                    CustomPaint(
                      ...
                      // 💡 L'appel est correct car la classe est définie ci-dessous
...
// 🎯 DÉFINITION DE LA CLASSE DE PEINTURE MANQUANTE
// Cette classe doit être dans le même fichier pour que _StudentHomePageState
// puisse y accéder et résoudre l'erreur.
