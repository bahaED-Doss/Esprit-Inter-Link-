...
import '../../../features/profile/pm_profile_page.dart';
import '../widgets/zoomable_image.dart';
import 'notification_page.dart';

// 🚀 NOUVEL IMPORT : Page de profil du PM
...
class _HomePageMockState extends State<_HomePageMock> {
  ...
  // 🚀 NOUVELLE MÉTHODE : Navigation vers le profil PM
  void _navigateToPMProfile() {
    Navigator.push(
      context,
            ...
            children: [
              SafeArea(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      // 🚀 MODIFICATION : Ajout du GestureDetector sur l'avatar
                      GestureDetector(
                        onTap: _navigateToPMProfile,
