...
import 'package:esprit_interlink/shared/presentation/todo/pm_projects_page.dart' hide PMProjectsPage;
...
import '../features/projects/presentation/pages/pm_projects_page.dart'; // ← ADDED
import 'route_names.dart';
import '../features/trophies/presentation/pages/trophies_page.dart';
import '../shared/presentation/pages/splash_entry.dart';
import 'package:esprit_interlink/features/offres/presentation/pages/hr_internship_list_page.dart';
...
class AppRouter {
  static final GoRouter router = GoRouter(
    ...
    routes: [
      // Splash Entry (initializes session and redirects)
      GoRoute(
        path: RouteNames.splash,
        name: 'splash',
        builder: (context, state) => const SplashEntry(),
      ),
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return ChangePasswordPage(resetToken: token);
        },
      ),
      ...
      // HR internships list route (accepts hrId via state.extra)
      GoRoute(
        path: '/hr/internships',
        name: 'hr_internships',
        builder: (context, state) {
          final hrId = (state.extra is int) ? state.extra as int : 0;
          return HRInternshipListPage(hrId: hrId);
        },
      ),
    ],
