...
import '../../../../features/tasks/presentation/pages/pm_task_view2.dart';
            ...
            children: [
              ...
              _isEditing
                ...
                trailing: IconButton(
                  ...
                  : _infoTile("Status", _selectedStatus),
              const SizedBox(height: 12),
                ...
                children: [
                  Expanded(
                    child: ListTile(
                      ...
                      subtitle: Text(_selectedStartDate != null ? df.format(_selectedStartDate!) : "-"),
                  ...
                  Expanded(
                    child: ListTile(
                      ...
                      subtitle: Text(_selectedEndDate != null ? df.format(_selectedEndDate!) : "-"),
                      onTap: _pickEndDate,
                    ),
                  ),
                ],
              ...
              // BOUTON KANBAN UNIQUEMENT
              if (!_isEditing && !isNew)
                Center(
                  child: ElevatedButton.icon(
                    icon: const Icon(Icons.view_kanban),
                    label: const Text('Go to Board'),
                    style: ElevatedButton.styleFrom(padding: const EdgeInsets.symmetric(horizontal: 32, vertical: 16)),
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (_) => PMTaskView(
